...
const BOUNDS={ground:GROUND_Y,ceiling:CEILING_Y,side:SIDE_LIMIT};
...
export function newFlight(){return{time:0,elapsed:0,rate:1,travel:0,km:0,x:0,y:5.4,vx:0,vy:0,speed:55,rpm:[0,0],earPhase:[0,0],earVelocity:[0,0],earTurns:[0,0],flow:0,boost:0,invuln:0,health:MAX_HEALTH,combo:0,rings:0,maxCombo:0,obstacleGrace:0,guitar:false,guitarTime:0,guitarDuration:GUITAR_DURATION,guitarCharge:0,guitarStrums:0,guitarExtended:0,lastGuitarStrum:null,trainHitsTotal:0,train:null,trainPending:false,launchAge:99,nearMisses:0,destroyed:0,wind:0,windWarning:0,windDirection:1,lastSide:0,lastTap:-10,station:0,peak:0,fliers:[],nextFlier:null,flierSerial:0,ended:null};}
...
export function step(s,dt){
 ...
 if(s.train){
  ...
  s.speed+=((s.guitar?300:90)-s.speed)*(1-Math.exp(-6*dt));advanceRoute(s,dt);stepFliers(s,BOUNDS);return;
 }
 ...
 advanceRoute(s,dt);stepFliers(s,BOUNDS);
}
