...
export class World{
 ...
 update(dt,s,mode,time,reduced=false){
  ...
  for(const b of this.blocks){
   ...
   // During the short grace only barriers that would arrive within it are hidden; the rest stay in view and arrive after it.
   if(s.obstacleGrace>0){if(z>-(s.speed*(s.rate??1)*s.obstacleGrace+60)){b.suppressed=true;b.obj.visible=false;}}
   else if(b.suppressed&&z<-150){b.suppressed=false;b.checked=false;b.obj.visible=!b.destroyed;}
  }
