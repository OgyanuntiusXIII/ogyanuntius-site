...
--   cover:site / cover:day:*  2026-09-05以前の「表紙に来た人だけ」の記録。**消さない**
--   meta:*             どこまでが Cloudflare Web Analytics 由来かの印
-- ⚠️ **2026-08-27〜09-05 の day:* と pv:* は Cloudflare Web Analytics から入れた値。**
--    自前で数え始めたのは 09-06。同じ日を二重に数えてはいない（加算ではなく期間で連結）。
--    **09-05以前の行を上書きし直さないこと。**
