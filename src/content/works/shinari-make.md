...
シナリオを書く作業と、それを人に配れる形に組む作業は、本来まったく別の苦労だった。

しなりメイクは、その二つを一本の流れにする。
ブロックを積んで書き、そのままページへ流し込み、本として書き出す。
...
- ページ分割と組版
- 配布形式への書き出し
- クトゥルフ神話TRPG 6版 / 7版 と、システムを問わない汎用モード
- 判定の「成功 / 失敗」の呼び名を、自分の卓の言葉に変える
- シナリオ基本情報の項目を、自分で組み立てる

## これから

全文検索と置換、そして段をまたぐ全幅レイアウトが残っている。
